...
class LoginPage extends React.Component {
    ...
    onSignInSubmit = (event) => {
        ...
        this.setupRecaptcha();
        const phoneNumber = `+92${this.state.phoneNumber}`;
                ...
                {this.state.showPhoneText ?
                    <div style={{ display: "block" }}>
                        ...
                        <form onSubmit={this.onSignInSubmit}>
                            <input type="text" placeholder="+92-12345-67890" class="number" name="phoneNumber" onChange={this.onChangeHandler} required="required" />
